...
function fetchresults() {
	...
	ruby "$(dirname "$0")/build_bcl_player_stats.rb" \
		"$ECF_DATA_DIR/matches.yaml" \
		"$(dirname "$0")/../../_data/mkmembers.csv" \
		"$ECF_DATA_DIR/player_stats.yaml"
}
...
function resetGeneratedFiles() {
	...
	echo "# File generated by importBCLData.sh script. Do not modify." > "$ECF_DATA_DIR/player_stats.yaml"
}
