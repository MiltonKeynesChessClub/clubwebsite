...
function resetGeneratedFiles() {
	...
	echo "# File generated by importBCLData.sh script. Do not modify." > "$ECF_DATA_DIR/bcl_table.yaml"
	echo "# File generated by importBCLData.sh script. Do not modify." > "$ECF_DATA_DIR/bcl_fixtures.yaml"
	echo "# File generated by importBCLData.sh script. Do not modify." > "$ECF_DATA_DIR/bcl_matches.yaml"
}
...
function processTable() {
	...
	TARGETFILE=$ECF_DATA_DIR/bcl_table.yaml
...
function processFixtures() {
	...
	echo ""            >> $ECF_DATA_DIR/bcl_fixtures.yaml
	echo "${DIVSLUG}:" >> $ECF_DATA_DIR/bcl_fixtures.yaml
	echo ""            >> $ECF_DATA_DIR/bcl_matches.yaml
	echo "${DIVSLUG}:" >> $ECF_DATA_DIR/bcl_matches.yaml

	for i in $(seq 0 $(($FIXTURECOUNT-1))); do
		TARGETFILE=$ECF_DATA_DIR/bcl_fixtures.yaml
...
function processFixtureGames() {
	...
	TARGETFILE=$ECF_DATA_DIR/bcl_matches.yaml
